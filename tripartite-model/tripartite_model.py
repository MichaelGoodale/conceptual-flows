...
class TripartiteModel(nn.Module):
    ...
    def __init__(self, dim:int =32, n_couplings:int =4, n_hidden=32, clip=1.0, radius=2.0, k=5, c=2/3.):
        '''
        Args:
        ...
        '''
        super().__init__()
        self.distribution = ConceptDistribution(dim, radius=radius, k=k, c=c)
